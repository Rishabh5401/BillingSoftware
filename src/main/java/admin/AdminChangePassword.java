...
public class AdminChangePassword extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AdminChangePassword.class.getName());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean status=dbOperation.checkOldPassword(old_password,"Rishabh@gmail.com");
        if (status) {
            ...
            if (new_password.trim().isEmpty()) {
                ...
                boolean status2 = dbOperation.updatePassword(new_password, "Rishabh@gmail.com");
                if (status2) {
